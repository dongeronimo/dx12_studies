...
common::OffscreenRTV::OffscreenRTV(int w, int h, common::IDxContext& context,
	DXGI_FORMAT imageFormat):offscreenImageFormat(imageFormat)
{
...
D3D12_CPU_DESCRIPTOR_HANDLE common::OffscreenRTV::DepthStencilView()
{
	return dsvHeap->GetCPUDescriptorHandleForHeapStart();
}

D3D12_CPU_DESCRIPTOR_HANDLE common::OffscreenRTV::RenderTargetView()
{
